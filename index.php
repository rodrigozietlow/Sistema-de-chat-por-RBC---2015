		...
		<div class="container-fluid">
			...
			<div class="row" id="chat">
				<div class="col-lg-12" id="cima-chat">
					...
					<div class="conversa conversa-right">aaa</div>
					<div class="clear-both"></div>
					<div class="conversa conversa-left">aaa</div>
					<div class="clear-both"></div>
					<div class="conversa conversa-right">aaa</div>
					<div class="clear-both"></div>
					<div class="conversa conversa-left">aaa</div>
					<div class="clear-both"></div>
					<div class="conversa conversa-right">aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa aaaaa    aaa aaaassdfaafsdghsgfjkhgfdkjahsgdfjkhagdfkjhagdfkjahffgkasadkhfasdfhagdsfkhjasdgfkadjgfasdkfjghasdfkjasdhgfkadfhgasdkghasdfkjasdhgfkdhgfaksdjfhgadksfhj</div>
					<div class="clear-both"></div>
					<div class="conversa conversa-left">aaa</div>
					<div class="clear-both"></div>
					<div class="conversa conversa-right">aaa</div>
